...
- Treat write commands as mutating Jira: `create`, `update`, `comments add`, `comments update`, `comments remove`, `comment`, `links add`, `links remove`, `attachments upload`, `attachments remove`, `transition`.
